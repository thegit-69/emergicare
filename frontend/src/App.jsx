    ...
    const renderRoutes = () => {
        ...
        return (
            <Routes>
                ...
                <Route path="/queue" element={<EmergencyQueueView emergencyQueue={emergencyQueue} setEmergencyQueue={setEmergencyQueue} triageEntries={triageEntries} user={user} fetchQueueData={fetchQueueData} />} />
